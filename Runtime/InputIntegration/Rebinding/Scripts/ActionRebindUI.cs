...
///Esto hace que al hacer rebind de Move tambien le muevas a los binds del joystick

/// <summary>
/// A reusable component with a self-contained UI for rebinding a single action.
/// </summary>
public class ActionRebindUI : MonoBehaviour
{
    [Header("Expande el asset de InputScheme y te saldran las acciones")]
    ...
    [Header("Es para poner un panel que de feedback del proceso de Rebind")]
    [Tooltip("Optional UI that will be shown while a rebind is in progress.")]
    [SerializeField]
    private GameObject m_RebindOverlay;

    [Header("Muestra que se esta rebindeando")]
    ...
    private static List<ActionRebindUI> s_RebindActionUIs;
    /// <summary>
    ...
    protected void OnEnable()
    {
        if (s_RebindActionUIs == null)
            s_RebindActionUIs = new List<ActionRebindUI>();
    ...
    [Serializable]
    public class UpdateBindingUIEvent : UnityEvent<ActionRebindUI, string, string, string>
    {
    }

    [Serializable]
    public class InteractiveRebindEvent : UnityEvent<ActionRebindUI, InputActionRebindingExtensions.RebindingOperation>
    {
    }
}